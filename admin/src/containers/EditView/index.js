...
import TitleFormGeneral from '../../components/TitleFormGeneral';
                      ...
                      return (
                        <div className="row" key={fieldsBlockIndex}>
                          {fieldsBlock.map(({ name, size }, fieldIndex) => {
                            ...
                            /* titles-comentarios */
                            if (name === 'tituloseccion' || name === 'titulogeneral') {
                              return (
                                <div style={{padding: '1em'}}>
                                    <TitleFormGeneral name={name} layout={currentContentTypeLayoutData} />
                                </div>
                              )
                            }
                            //////////////////////////
